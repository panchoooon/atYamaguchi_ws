...
"""autogenerated by genpy from hsr_common_pkg/SoundEffectAction.msg. Do not edit."""
import sys
...
class SoundEffectAction(genpy.Message):
  _md5sum = "efb6a5a1d3a8e767c7d3c28bb54f3c9a"
  _type = "hsr_common_pkg/SoundEffectAction"
...
"""
  ...
  _slot_types = ['hsr_common_pkg/SoundEffectActionGoal','hsr_common_pkg/SoundEffectActionResult','hsr_common_pkg/SoundEffectActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SoundEffectAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = hsr_common_pkg.msg.SoundEffectActionGoal()
      if self.action_result is None:
        self.action_result = hsr_common_pkg.msg.SoundEffectActionResult()
      if self.action_feedback is None:
        self.action_feedback = hsr_common_pkg.msg.SoundEffectActionFeedback()
    else:
      self.action_goal = hsr_common_pkg.msg.SoundEffectActionGoal()
      self.action_result = hsr_common_pkg.msg.SoundEffectActionResult()
      self.action_feedback = hsr_common_pkg.msg.SoundEffectActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.sound_effect_goal
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_result.result.sound_effect_result, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.action_feedback.feedback.sound_effect_feedback))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.sound_effect_goal = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.sound_effect_goal = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.sound_effect_result, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      self.action_result.result.sound_effect_result = bool(self.action_result.result.sound_effect_result)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.sound_effect_feedback,) = _struct_B.unpack(str[start:end])
      self.action_feedback.feedback.sound_effect_feedback = bool(self.action_feedback.feedback.sound_effect_feedback)
      return self
