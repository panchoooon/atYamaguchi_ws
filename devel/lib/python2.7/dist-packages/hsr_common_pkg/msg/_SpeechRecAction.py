...
"""autogenerated by genpy from hsr_common_pkg/SpeechRecAction.msg. Do not edit."""
import sys
...
class SpeechRecAction(genpy.Message):
  _md5sum = "64150973509f5d39f3ab8284cd85bc7e"
  _type = "hsr_common_pkg/SpeechRecAction"
...
"""
  ...
  _slot_types = ['hsr_common_pkg/SpeechRecActionGoal','hsr_common_pkg/SpeechRecActionResult','hsr_common_pkg/SpeechRecActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SpeechRecAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = hsr_common_pkg.msg.SpeechRecActionGoal()
      if self.action_result is None:
        self.action_result = hsr_common_pkg.msg.SpeechRecActionResult()
      if self.action_feedback is None:
        self.action_feedback = hsr_common_pkg.msg.SpeechRecActionFeedback()
    else:
      self.action_goal = hsr_common_pkg.msg.SpeechRecActionGoal()
      self.action_result = hsr_common_pkg.msg.SpeechRecActionResult()
      self.action_feedback = hsr_common_pkg.msg.SpeechRecActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.speech_rec_goal
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.speech_rec_result
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.action_feedback.feedback.speech_rec_feedback))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.speech_rec_goal = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.speech_rec_goal = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.speech_rec_result = str[start:end].decode('utf-8')
      else:
        self.action_result.result.speech_rec_result = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.speech_rec_feedback,) = _struct_B.unpack(str[start:end])
      self.action_feedback.feedback.speech_rec_feedback = bool(self.action_feedback.feedback.speech_rec_feedback)
      return self
